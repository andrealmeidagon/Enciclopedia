...
<html>
    ...
    <body>
       <!-- Header -->
        ...
        <div class="container">
            <div class="span12">
                <form role="form" action="TopicoController" method="post">
                    <%
                        if(session.getAttribute("nvlTopico")!=null){
                            String nvl = (String)session.getAttribute("nvlTopico");
                            if(Integer.parseInt(nvl)==1){
                                out.print("<div class='form-group'><label for='exampleInputEmail1'>Título do tópico* </label><input type='text' class='form-control' id='exampleInputEmail1' name='titulo' /></div>");
                            }else{
                                out.print("<div class='form-group'><label for='exampleInputEmail1'>Especificação do tópico* </label><input type='text' class='form-control' id='exampleInputEmail1' name='especific' /></div>");
                            }
                        }
                    %>
                    ...
                    <input type="submit" class="btn btn-danger btn-large" name="ref" value=
                        <%
                            if(request.getAttribute("value")!=null){
                                String ref = (String)request.getAttribute("value");
                                out.print(ref);
                            }
                        %>
                    >
