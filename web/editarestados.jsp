...
<div class="container">
    <div class="span12">
        <table class="table table-striped">
            <thead>
                <tr><th><a href="UfController?ref=adicionar" class="btn btn-success"><i class="icon-white icon-plus"></i> Adicionar Estado</a></th></tr>
                <tr>
                    <th></th>
                    <!--<th><a href="editarestado.jsp" class="btn btn-primary btn-xs"> Editar</a> <title> </title><button type="button" class="btn btn-danger btn-xs"><i class="icon-remove"></i></button></th>-->
                    <th>Estado</th>
                    <th>Sigla</th>
            ...
            <tbody>
                <%
                    if(request.getAttribute("bdUf")!=null){
                        ArrayList<Uf> arUf = (ArrayList<Uf>) request.getAttribute("bdUf");
           
                        for(int i=0; i<arUf.size(); i++){
                            out.print("<tr>");
                            out.print("<td><a href='UfController?ref=editar&id="+arUf.get(i).getId_uf()+"' class='btn btn-primary btn-xs'> Editar</a> <title> </title><a href='UfController?ref=excluir&id="+arUf.get(i).getId_uf()+"' class='btn btn-danger btn-xs'><i class='icon-remove'></i></a></td>");
                            out.print("<td>"+arUf.get(i).getNom_uf()+"</td>");
                            out.print("<td>"+arUf.get(i).getSigla_uf()+"</td>");
