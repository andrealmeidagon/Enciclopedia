...
<form role="form" action="InstituicaoController" method="post">
                <div class="form-group">
                     <label for="exampleInputEmail1">Instituição </label><input type="text" class="form-control" id="exampleInputEmail1" name="nome" />
                </div>
    
                <div class="form-group">
                     <label for="exampleInputEmail1">Sigla instituição </label><input type="text" class="form-control" id="exampleInputEmail1" name="sigla" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="btn-group">
                        <select class="selectpicker" name="cidade_id">
                            <%
                                if(request.getAttribute("listarcidade")!=null && request.getAttribute("listaruf")!=null){
                                    ArrayList<Cidade> arRet = (ArrayList<Cidade>) request.getAttribute("listarcidade");
                                    ArrayList<Uf> arUf = (ArrayList<Uf>) request.getAttribute("listaruf");
                                    for(int i=0; i<arRet.size(); i++){
                                        out.print("<option value='" + arRet.get(i).getId_cidade()+"'>"+arRet.get(i).getNom_cidade());
                                        for(int j=0; j<arUf.size();j++){
                                            if(arRet.get(i).getUf_id()==arUf.get(j).getId_uf()){
                                                out.print(" - " + arUf.get(j).getSigla_uf()+ "</option>");
                                                break;
                                            }
                                        }
                                    }
                 ...
                 <input type="submit" class="btn btn-danger btn-large" name="ref" value="Cadastrar">
            </form>
    <div class="span12">
<div class="container">
</div>
