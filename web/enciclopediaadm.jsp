            ...
            <div class="container">
                <div class="row">
                    <div class="span12">
                        ...
                        <h2>Cadastrar / </h2>
                        <p>Cadastre uma nova vacina ou doença na enciclopédia</p>
...
<div class="container">
  ...
  <thead>
    <tr>
      <th><button  type="button" class="btn btn-primary btn-xs">Editar</button> <title> </title><button type="button" class="btn btn-danger btn-xs"><i class="icon-remove"></i></button></th>
