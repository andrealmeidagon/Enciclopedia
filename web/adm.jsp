...
<div class="team container">
    <div class="row">
        <div class="team-text span4">
            ...
            <h4>Jogo</h4>
            <a href="jogoadm.jsp"><i class="icon-check"></i><br />Editar</a>
        ...
        <div class="team-text span4">
            ...
            <a href="enciclopediaadm.jsp"><i class="icon-check"></i><br />Editar</a>

        </div>
        <div class="team-text span4">

            <h4>Cartão-Espelho</h4>
            <a href=""><i class="icon-check"></i><br />Em construção</a>
