...
<div class="container">
    <div class="span12">
        <table class="table table-striped">
            <thead>
                <tr><th><a href="" class="btn btn-success"><i class="icon-white icon-plus"></i> Adicionar Doença</a></th></tr>
                <tr>
                    <th></th>
                    <th>Doença</th>
                </tr>
             ...
             <tbody>
                 <%
                    if(request.getAttribute("bdDoenca")!=null){
                        ArrayList<Doenca> arUf = (ArrayList<Doenca>) request.getAttribute("bdDoenca");
                        for(int i=0; i<arUf.size(); i++){
                            out.print("<tr>");
                            out.print("<td><a href='DoencaController?ref=editar&id="+arUf.get(i).getId_doenca()+"' class='btn btn-primary btn-xs'> Editar</a> <title> </title><a href='DoencaController?ref=excluir&id="+arUf.get(i).getId_doenca()+"' class='btn btn-danger btn-xs'><i class='icon-remove'></i></a><title> </title> <a href='DoencaController?ref=listarsecao&id="+arUf.get(i).getId_doenca()+" type='button' class='btn btn-xs'><i class='icon-align-left'></i></a></td>");
                            out.print("<td>"+arUf.get(i).getNom_doenca()+"</td>");
                            out.print("</tr>");
