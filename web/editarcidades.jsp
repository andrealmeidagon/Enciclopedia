...
<div class="container">
    <div class="span12">
        <table class="table table-striped">
            <thead>
                <tr><th><a href="CidadeController?ref=listaruf" class="btn btn-success"><i class="icon-white icon-plus"></i> Adicionar Cidade</a></th></tr>
                <tr>
                    <th></th>
                   <!-- <th><a href="editarcidade.jsp" class="btn btn-primary btn-xs"> Editar</a> <title> </title><button type="button" class="btn btn-danger btn-xs"><i class="icon-remove"></i></button></th>-->
                    <th>Cidade</th>
                    <th>Estado</th>
             ...
             <tbody>
                <%
                    if(request.getAttribute("bdCidade")!=null && request.getAttribute("bdUf")!=null){
                        ...
                        for(int i=0; i<arCidade.size(); i++){
                            out.print("<tr>");
                            out.print("<td><a href='CidadeController?ref=editar&id="+arCidade.get(i).getId_cidade()+"' class='btn btn-primary btn-xs'> Editar</a> <title> </title><a href='CidadeController?ref=excluir&id="+arCidade.get(i).getId_cidade()+"' class='btn btn-danger btn-xs'><i class='icon-remove'></i></a></td>");
                            out.print("<td>"+arCidade.get(i).getNom_cidade()+"</td>");
                            
                            for(int j=0; j<arUf.size(); j++){
                                if(arUf.get(j).getId_uf()==arCidade.get(j).getUf_id())
                                    out.print("<td>"+arUf.get(j).getSigla_uf()+"</td>");
                            }
                            out.print("</tr>");
